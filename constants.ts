import { Group, GroupKey, Question, Statement, SuggestionMap } from './types';
...
export const STATEMENTS_DATA: Statement[] = [
  ...
  { text: 'Bạn thấy hứng thú khi được tham gia vào các cuộc thi hoặc hoạt động có yếu tố trí tuệ, kiến thức.', group: 'Học thuật' },
  { text: 'Bạn thấy thích thú khi dành nhiều giờ để chuẩn bị một bài thuyết trình hoặc dự án nghiên cứu.', group: 'Học thuật' },
  ...
  { text: 'Bạn thường thích tham gia hoặc thưởng thức những buổi biểu diễn nghệ thuật trực tiếp.', group: 'Nghệ thuật' },
  ...
  { text: 'Bạn thấy thoải mái khi được tương tác với nhiều kiểu người khác nhau, và điều chỉnh cách nói chuyện phù hợp từng đối tượng.', group: 'Xã hội' },
...
export const SUGGESTIONS: SuggestionMap = {
  academic: ['CLB Toán – Khoa học', 'CLB Lập trình', 'CLB Tranh biện'],
  artistic: ['CLB Âm nhạc', 'CLB Múa', 'CLB Kịch'],
  cultural: ['CLB Tiếng Anh', 'CLB Văn hoá dân gian', 'CLB Ẩm thực'],
  social: ['CLB Tình nguyện', 'CLB Truyền thông – PR', 'CLB Kỹ năng sống'],
  sports: ['CLB Bóng đá', 'CLB Cầu lông', 'CLB Võ thuật']
};